...
from classifiers.svm_binaria import *
import os
import matplotlib.pyplot as plt
...
def corre(modelo):
	...
	with open(os.path.dirname(os.path.realpath(__file__)) + "/Models/vect_tresclasses", 'rb') as fid:
		v = pickle.load(fid)
	a = 0
...
if __name__ == '__main__':
	...
	#########
	tresh_hold = 0.1
	corre('/Users/luisduarte/PycharmProjects/Bot_Controler/classifiers/Models/svm_muticlass.pickle')
	#for i in range(10000):
		#for elem in (corre_modelo_completo("Models/svm_binaria_v3.pickle","Models/svm_muticlass.pickle","Qual é a legislação aplicável à exploração dos estabelecimentos de alojamento local?",tresh_hold)):
			#print(elem)
